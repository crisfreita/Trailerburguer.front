...
app.method = {
  ...
  carregarDadosEmpresa: () => {
    document.querySelector(".nome-empresa").innerHTML =
      app.method.obterValorSessao("Nome");
    document.querySelector(".email-empresa").innerHTML =
      app.method.obterValorSessao("Email");
  ...
  // exibe um modal personalizado (ex: QR Code PIX)
  exibirModalCustom: (titulo, conteudoHtml) => {
    // remove modal anterior se existir
    const antigo = document.getElementById("modalCustom");
        ...
        <div class="modal fade" id="modalCustom" tabindex="-1" aria-labelledby="modalCustomLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body text-center">${conteudoHtml}</div>
    ...
    // exibe com Bootstrap puro (sem jQuery)
    const modalElement = document.getElementById("modalCustom");
